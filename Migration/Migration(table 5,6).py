...
#file = open(r'Table 5(200 50 10 10 10)/policy.txt' , 'r')
file = open(r'Table 6 (50 50 10 10 40 1 4)/policy.txt' , 'r')
...
#file = open(r'Table 5(200 50 10 10 10)/UAR.txt' , 'r')
file = open(r'Table 6 (50 50 10 10 40 1 4)/UAR.txt' , 'r')
...
#file = open(r'Table 5(200 50 10 10 10)/OAR.txt' , 'r')
file = open(r'Table 6 (50 50 10 10 40 1 4)/OAR.txt' , 'r')
line = file.readline()
R=[] 
RA=[]
i=1         
...
print('Calculate the number of user constraints and conditional permissions.')
UC=[]
Permission=[]
Permission_set=[]
EU=[]
...
for role in range(n_r):
    ...
    if flag_rp and flag_ur and role not in Role_active:
        Role_active.append(role)
print(f'\nThe number of roles assigned:    {len(Role_active)}: {Role_active}')
...
print(f'\nThe number of active user-role assignment:    {number_ura_a}')
...
print(f'\nThe number of active role-permission assignment:    {number_rpa_a}')
...
print(f'\nThe number of RH:    {len(RH)}')
print(f'\nThe number of active RH:    {number_rh_a}')
